 ...
 * 统计脱落率
 */
public class CountFallOffRateByRegionEachCategory {
    ...
    public static void main(String[] args) throws IOException {
        ...
        //华北区
        //String region = "263,351,11353,273,392,355,262,107,155,334,280,121,82,305,404,94,378,48,386,7,376,385,384";
        //西北区
        ...
        while ((line = br.readLine()) != null){
            ...
            if("0".equals(attr[1].trim()))
                continue;
            Integer count = retMap.get(attr[1].trim());
            if(count == null){
                count = 1;
            }else{
                count ++;
            }
            retMap.put(attr[1].trim(), count);
        }
